...
const BookAppointmentButton = forwardRef(
  ({ propertyId, propertyOwnerId, propertyTitle }, ref) => {
    ...
    const handleBookingSuccess = (appointment) => {
      toast.success(
        "Đặt lịch xem phòng thành công! Chủ trọ sẽ xác nhận và liên hệ với bạn."
      );
      setShowBookingModal(false);
    };

    useImperativeHandle(ref, () => ({
      open: () => handleBookAppointment(),
